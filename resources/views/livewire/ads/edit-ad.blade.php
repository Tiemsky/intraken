<div class="col-lg-6">
    <div class="post_form mt-50">
        <div class="post_title d-flex justify-content-between">
            <h5 class="title">Ad Categories</h5>
            <button class="btn btn-info"
                    wire:click.prevent='updateCategory'>change</button>
        </div>
        @if ($success_message)
        ...
        <form wire:submit.prevent='updateAd'>
           ...
           @if ($showCurrentCategory)
                <div class="single_form ">
                    ...
                    <input type="text" 
                            class="form-control"
                            id="Category"
                            wire:model='currentCategory' 
                            disabled>
                </div>
                <div class="single_form ">
                    <label for="State">SubCategory</label>
                    <input type="text" 
                            class="form-control"
                            id="SubCategory"
                            wire:model='currentSubCategory' 
                            disabled>
                </div>
                @if ($isChildCategoryExist)
                    <div class="single_form ">
                        <label for="City">ChildCategory</label>
                        <input type="text" 
                                class="form-control"
                                id="ChildCategory"
                                wire:model='currentChildCategory' 
                                disabled>
                    </div>
                @endif
          ...
          @endif
            ...
            <div class="post_title d-flex justify-content-between">
                ...
                <button class="btn btn-info"
                        wire:click.prevent='updateLocation'>change</button>
            </div>
        ...
        {{-- *******************************************************************************************  --}}
          ...
          @endif
            ...
            @if (!$showCurrentCategory || !$showCurrentLocation)
