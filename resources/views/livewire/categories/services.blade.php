                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="single_ads_card mt-30">
                                                <div class="ads_card_image">
                                                    <img src="{{ asset('storage/advertisement/'.$service->image->photo0)}}" alt="ads">
                                                </div>
                                                <div class="ads_card_content">
                                                    <div class="meta d-flex justify-content-between">
                                                        <p>{{$service->category->category_name}} </p>
                                                        @livewire('ads.like', ['ad_id' => $service->id])
                                                    </div>
                                                    <h4 class="title">
                                                        <a href="{{route('ad.show',[app()->getLocale(), $service->slug])}} ">
                                                            {{$service->title}}
                                                        </a>
                                                    </h4>
                                                    ...
                                                    <div class="ads_price_date d-flex justify-content-between">
                                                        <span class="price">
                                                            {{$service->price}} {{ $service->currency == 'Dollar' ? '$' : ($service->currency == 'Euro' ? '€' : 'FCFA') }}
                                                        </span>
                                ...
                                @forelse ($services as $service)
                                    <div class="single_ads_card ads_list d-sm-flex mt-30">
                                        ...
                                        <div class="ads_card_content media-body">
                                            ...
                                            <h4 class="title">
                                                <a href="#">{{$service->category->category_name}}</a>
                                            </h4>
                                            <p><i class="far fa-map-marker-alt"></i>
                                                {{$service->country->name}}-
                                                {{$service->state->name}}-
