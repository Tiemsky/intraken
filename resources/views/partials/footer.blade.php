        ...
        <div class="container">
            <div class="footer_copyright_wrapper text-center d-sm-flex justify-content-between align-items-center">
                ...
                <div class="payment mt-15">
                    <ul>
                        <li><a href="#"><img src="{{ asset('assets/images/icon/payment-method1.jpg') }} " alt="payment"></a></li>
                        <li><a href="#"><img src="{{ asset('assets/images/icon/payment-method2.jpg') }} " alt="payment"></a></li>
                        <li><a href="#"><img src="{{ asset('assets/images/icon/payment-method3.jpg') }} " alt="payment"></a></li>
                        <li><a href="#"><img src="{{ asset('assets/images/icon/payment-method4.jpg') }} "  alt="payment"></a></li>
                    </ul>
                </div>
            </div>
        </div>
